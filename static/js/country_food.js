d3.csv("https://raw.githubusercontent.com/plotly/datasets/master/gapminder_with_codes.csv").then(function(rows){
...
Plotly.newPlot('animatedMap', data, layout).then(function() {
